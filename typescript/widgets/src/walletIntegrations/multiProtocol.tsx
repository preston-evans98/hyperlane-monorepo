...
export function useConnectFns(): Record<ProtocolType, () => void> {
  ...
  return useMemo(
    ...
    [onConnectEthereum, onConnectSolana, onConnectCosmos, onConnectStarknet, onConnectSovereign],
  );
}
...
export function useDisconnectFns(): Record<ProtocolType, () => Promise<void>> {
  ...
  return useMemo(
    ...
    [disconnectEvm, disconnectSol, disconnectCosmos, disconnectStarknet, disconnectSovereign],
  );
}
